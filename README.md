...
後端先依正式進場權限、交易品質、資料新鮮度、剩餘 R:R、較低滑價與較高流動性選出最多 20 張卡；續走結果不參與這個截斷，避免舊單點快照或尚未完成採樣的新卡改變入選資格。前端只會在已入選卡片內把平均續走狀態用於呈現順位。這不會刪卡或改變進場權限；同一 Episode 也保留原 Entry／Stop／Target，不因刷新而漂移。
