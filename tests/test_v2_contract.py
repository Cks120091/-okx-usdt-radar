...
class V33ContractTests(unittest.TestCase):
    ...
    def test_mobile_ui_triggers_real_scan_and_uses_chinese_lifecycle(self):
        ...
        self.assertIn("okx-radar-shell-v3.3-plain-preflight-1", service_worker)
        ...
        self.assertIn("這個「即時判定」在做什麼？", html)
        self.assertIn("① 原始訊號代表什麼", html)
        ...
        self.assertIn("status==='WAIT_RETEST'&&adverse>0", html)
        self.assertIn("status==='SIGNAL_INVALIDATED'", html)
